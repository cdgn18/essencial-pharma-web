...
function ep_enqueue_assets() {
    ...
    // Main CSS
    wp_enqueue_style('ep-main', get_template_directory_uri() . '/assets/css/main.css', ['ep-fonts'], '1.0.0');

    // WooCommerce overrides
    wp_enqueue_style('ep-wc', get_template_directory_uri() . '/assets/css/wc-overrides.css', ['ep-main'], '1.0.0');
