...
<header class="header">
    <div class="container">
        ...
        <!-- Col 2: Logo — centered automatically by 1fr auto 1fr grid -->
        ...
        <!-- Mobile nav overlay — all links, shown when hamburger is active -->
