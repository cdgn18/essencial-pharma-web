...
<section class="section promo-section" id="publicidad">
    <div class="container">
        <div class="promo-banners-grid">
            <!-- Banner Capilar -->
            <div class="promo-banner-card capilar-banner glass-panel" onclick="filterShopCategory('dermocosmetica')">
                <div class="promo-card-content">
                    <span class="promo-brand">ESSENCIAL PHARMA</span>
                    <h3 class="promo-card-title">DERMOCOSMÉTICA<br>CAPILAR</h3>
                    <p class="promo-card-tagline">Cuidado clínico y salud folicular</p>
                </div>
                <div class="promo-card-products">
                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/dermo_shampoo.png" alt="Shampoo" class="prod-stack stack-1">
                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/dermo_tonico.png" alt="Tónico" class="prod-stack stack-2">
                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/dermo_tratamiento.png" alt="Tratamiento" class="prod-stack stack-3">
                </div>
            </div>

            <!-- Banner Veterinario -->
            <div class="promo-banner-card vet-banner glass-panel" onclick="filterShopCategory('veterinaria')">
                <div class="promo-card-content">
                    <span class="promo-brand">ESSENCIAL PHARMA</span>
                    <h3 class="promo-card-title">LÍNEA<br>VETERINARIA</h3>
                    <p class="promo-card-tagline">Salud y protección para mascotas</p>
                </div>
                <div class="promo-card-products">
                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/DERMOPROTECTORMASCOTAS.jpg" alt="Shampoo Mascotas" class="prod-stack stack-1">
                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/SUPLEMENTOALIMENTICIOCANINO.jpg" alt="Suplemento" class="prod-stack stack-2">
                </div>
            </div>
        </div>
    </div>
